...
// If handlers cannot keep up and the internal buffer (see [WithEventBuffer])
// fills, further events are dropped and logged rather than stalling — and
// risking the liveness of — the connection. The context is canceled when the
// session closes.
